...
class ViewController: UIViewController,UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate  {
    ...
    var bin = ["Top Shelf","Bottom Drawer","Last Cabinet"];
    var loc = ["Closet","Basement","Storage"];
    ...
    func searchTap(_ sender: UIButton) {
        ...
        dic.updateValue(bin , forKey: "bin")
        dic.updateValue(loc , forKey: "loc")
